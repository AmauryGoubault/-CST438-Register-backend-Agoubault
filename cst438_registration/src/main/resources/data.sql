...
(1,'test','test@csumb.edu',NULL,0, "$2a$10$qPQtchdqiBRL1rHmJ2dX/OdfazjCyWwQB77kHG/QcuVV2mLuoZDiu
", "admin")
(2,'david','dwisneski@csumb.edu',NULL,0, "$2a$10$qPQtchdqiBRL1rHmJ2dX/OdfazjCyWwQB77kHG/QcuVV2mLuoZDiu
", "admin"),
(3,'tom', 'trebold@csumb.edu', NULL, 0, "$2a$10$qPQtchdqiBRL1rHmJ2dX/OdfazjCyWwQB77kHG/QcuVV2mLuoZDiu
", "admin");
